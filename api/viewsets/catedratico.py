...
from api.models import Catedratico, Profile, Rol, Profesion
from api.serializers import CatedraticoSerializer, CatedraticoRegisterSerializer
...
class CatedraticoViewset(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        ...
        if self.action == 'list' or self.action == 'retrieve':
            ...
            return CatedraticoRegisterSerializer
    ...
    def create(self, request):
        try:
            data = request.data
            serializer = CatedraticoRegisterSerializer(data = data)
